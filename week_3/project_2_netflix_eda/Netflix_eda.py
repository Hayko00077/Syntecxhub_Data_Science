...
# DATASET_URLS = [
#     "https://raw.githubusercontent.com/shivamb/netflix-shows/refs/heads/master/netflix_titles.csv",
#     "https://raw.githubusercontent.com/kanchana-ranawaka/netflix-dataset/main/netflix_titles.csv",
# ]

# Set to None to skip downloading and use local file below
DATASET_URL = None
# DATASET_URL = ATASET_URLS[0]
